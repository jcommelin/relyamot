...
Another important question/lemma (which should probably come before the
previous paragraphs) is whether the following diagram commutes:
\[
	\begin{tikzcd} % {{{-
		\smpr_{S} \rar{f \circ \_} \dar{h_{S}}
		& \smpr_{S'} \dar{h_{S'}} \\
